...
public class ActiveMQMain {
	...
	public static void main(String[] args) throws JMSException {
		...
		Thread topicConsumerThread1 = new Thread(new TopicConsumer(
				connectionFactory));
		topicConsumerThread1.start();
		Thread topicConsumerThread2 = new Thread(new TopicConsumer(
				connectionFactory));
		topicConsumerThread2.start();
		try {
			Thread.sleep(1000);
